...
module.exports = class extends Language {
	...
	constructor(...args) {
		...
		this.language = {
			...
			COMMAND_HELP_FOOTER: (prefix) => `For more info please use ${prefix}help <command>`,
			...
			COMMAND_CONF_SERVER_DESCRIPTION: 'Define guild settings.',
			...
			COMMAND_STATS: (memUsage, uptime, users, guilds, channels, klasaVersion, discordVersion, processVersion, message) => [
				...
				`• Shard      :: ${(message.guild ? message.guild.shardID : 0) + 1} / ${this.client.options.totalShardCount || 1}`
			],
			COMMAND_STATS_DESCRIPTION: 'Provides some details about the bot and stats.',
			MESSAGE_PROMPT_TIMEOUT: 'The prompt has timed out.',
			TEXT_PROMPT_ABORT_OPTIONS: ['abort', 'stop', 'cancel'],
			COMMAND_PROFILE_DESCRIPTION: 'shows profile of user!',
			COMMAND_HELP_SERVERONLY: 'Server Only',
			COMMAND_PREFIX_DESCRIPTION: 'Changes the prefix.',
			COMMAND_PREFIX_REMINDER: prefix => `My current prefix is ${code`${prefix}`}.`,
			COMMAND_PREFIX_SUCCESS: prefix => `My prefix is now${code`${prefix}`}`,
			COMMAND_CHECK_DESCRIPTION: 'Check if slug is free or not.',
			...
			COMMAND_LIKES_DESCRIPTION: 'show top likes',
			COMMAND_DEBUG_DESCRIPTION: 'debug info of various endpoints',
			COMMAND_REMINDME_DESCRIPTION: 'reminds you',
			COMMAND_GENEMBED_DESCRIPTION: 'generates a embed'
		};
	}
